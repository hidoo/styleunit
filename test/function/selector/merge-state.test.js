...
describe('@function selector-merge-state($type, $additional-selectors)', () => {
  ...
  it('should return merged selectors if argument "$type" is valid.', async () => {
    const cases = [
      ...
      },
      {
        params: [['$type: "focus"']],
        expected:
          '.selector{content:":hover";content:":focus";content:".is-focus"}'
      },
      {
  ...
  it('should return merged selectors without default value if variable in defaults is not set.', async () => {
    const cases = [
      {
        params: [['$type: "focus"'], ['$selector-focus: ""']],
        expected: '.selector{content:":hover";content:":focus"}'
      },
      {
        params: [['$type: "selected"'], ['$selector-selected: ""']],
        expected: '.selector{content:":checked"}'
      },
      {
        params: [['$type: "disabled"'], ['$selector-disabled: ""']],
        expected: '.selector{content:":disabled"}'
      },
      {
        params: [['$type: "current"'], ['$selector-current: ""']],
        expected: ''
      },
      {
        params: [['$type: "active"'], ['$selector-active: ""']],
        expected: ''
      }
    ];
  ...
  it('should return merged selectors if argument "$additional-selectors" is set.', async () => {
    const cases = [
      {
        params: [['$type: "link"', '$additional-selectors: (".is-hoge")']],
        expected:
          '.selector{content:":link";content:":visited";content:".is-hoge"}'
      },
      {
        params: [['$type: "focus"', '$additional-selectors: (".is-hoge")']],
        expected:
          '.selector{content:":hover";content:":focus";content:".is-focus";content:".is-hoge"}'
      },
      {
        params: [['$type: "selected"', '$additional-selectors: (".is-hoge")']],
        expected:
          '.selector{content:":checked";content:".is-selected";content:".is-hoge"}'
      },
      {
        params: [['$type: "disabled"', '$additional-selectors: (".is-hoge")']],
        expected:
          '.selector{content:":disabled";content:".is-disabled";content:".is-hoge"}'
      },
      {
        params: [['$type: "current"', '$additional-selectors: (".is-hoge")']],
        expected: '.selector{content:".is-current";content:".is-hoge"}'
      },
      {
        params: [['$type: "active"', '$additional-selectors: (".is-hoge")']],
